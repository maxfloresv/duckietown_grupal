...
Primero se abre la consola en la cual se debe ingresar al Duckiebot utilizando `ssh -X duckiebot@duckiebot.local` y se ingresa la contraseña. Luego se abren las carpetas ingresando `cd \duckiebot\catkin_ws\src\desafios_2022\src`. Se ejecuta `roslaunch ros_cap duckie_core.local` y se ejecuta el programa.
...
Se ejecuta `cd duckiebot_pc` y luego `python3 voice2text.py` para ejecutar el programa del PC.
...
Luego se define la función tiempo la cual al ingresar un ángulo, calcula el tiempo que le 
